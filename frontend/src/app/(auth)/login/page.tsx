...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      // 【変更履歴】なぜXSS/CSRFの天秤の話が無くなったか
      //   → 以前はaccessToken・refreshTokenの両方をlocalStorage（persist）に保存しており、
      //     「localStorageのXSSリスク」と「CookieのCSRFリスク」を天秤にかけてlocalStorageを選んでいた。
      //     今はrefreshTokenをHttpOnly Cookieに変更し、accessTokenもメモリ上にしか置かないため、
      //     この天秤自体が過去のものになった。
      //
